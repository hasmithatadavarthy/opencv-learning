...
src_image_paths = [
    r"C:\Users\Hai\OneDrive\Desktop\OPENCV\learning opencv\Scripts\PROJECTS\project33\Face_Swaping\images\bill_gates.jpg",
    r"C:\Users\Hai\OneDrive\Desktop\OPENCV\learning opencv\Scripts\PROJECTS\project33\Face_Swaping\images\donald_trump.jpg",
    r"C:\Users\Hai\OneDrive\Desktop\OPENCV\learning opencv\Scripts\PROJECTS\project33\Face_Swaping\images\elon_musk.jpg",
    r"C:\Users\Hai\OneDrive\Desktop\OPENCV\learning opencv\Scripts\PROJECTS\project33\Face_Swaping\images\will_smith.jpg"
]
...
while True:
    ...
    for triangle_index in indexes_triangles:
        ...
        points, src_cropped_triangle, cropped_triangle_mask, _ = media_utils.triangulation( triangle_index=triangle_index,landmark_points=src_landmark_points,img=src_image)
        # Triangulation of second face
        points2, _, dest_cropped_triangle_mask, rect = media_utils.triangulation(triangle_index=triangle_index,landmark_points=dest_landmark_points)
        
        warped_triangle = media_utils.warp_triangle(rect=rect, points1=points, points2=points2, src_cropped_triangle=src_cropped_triangle, dest_cropped_triangle_mask=dest_cropped_triangle_mask)
        
        # Reconstructing destination face
        media_utils.add_piece_of_new_face(new_face=new_face, rect=rect, warped_triangle=warped_triangle)
        
    result = media_utils.swap_new_face(dest_image=dest_image, dest_image_gray=dest_image_gray,dest_convexHull=dest_convexHull, new_face=new_face)
